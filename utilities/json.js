    ...
    getRegions(country_id) {
        ...
        try {
            ...
            for (var i = 0; i < N; i++) {
                ...
                if (this.Regions[i].CountryID == country_id) {
                    regions[k] = this.Regions[i];
                    k++;
                }
            }
            ...
            alert(err.message + " in LocationsDB.getRegions(country_id)");
        }
    ...
    getStates(region_id) {
        ...
        try {
            ...
            for (var i = 0; i < N; i++) {
                ...
                if (this.States[i].RegionID == region_id) {
...
function writeRegions(regions) {
    ...
    try {
        ...
        var regionstr = "<option value=\"\" selected disabled hidden>Select your region/province</option>";
...
function createLists() {
    ...
    try {
        ...
        countryList[0] = new Country(102, 'Ireland');
        countryList[1] = new Country(153, 'Nigeria');
        countryList[2] = new Country(229, 'United Kingdom');

        locations.Countries = countryList;
